-- ============================================================
-- ContAuditAI — Migración 003: Seed estructura EFOS/EDOS
-- Nota: los datos reales se cargan via worker desde el SAT.
-- Este seed inserta ejemplos para desarrollo local.
-- ============================================================

INSERT INTO efos_edos (rfc, nombre_contribuyente, tipo, situacion, numero_en_lista, fecha_publicacion_dof)
VALUES
