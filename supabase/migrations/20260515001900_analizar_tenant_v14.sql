-- ============================================================
-- ContAuditAI — analizar_tenant v14
-- Fix: SELECT INTO sin fila sobreescribía variables con NULL,
-- eliminando alertas HUERFANO_XML, FACTURA_VENCIDA y
-- MATERIALIDAD_FALTANTE cuando el tenant no tiene config.
-- Solución: COALESCE después del SELECT para restaurar defaults.
-- ============================================================
...
-- Permite leer la config desde el cliente (PostgREST) para mostrar valores guardados en la UI
