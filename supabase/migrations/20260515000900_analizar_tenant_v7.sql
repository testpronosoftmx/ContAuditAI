-- ============================================================
-- ContAuditAI — analizar_tenant v7
-- Fix 1: Match Perfecto por UUID en concepto/referencia bancaria
-- Fix 2: CANCELACION_RETROACTIVA recuperada
-- Fix 3: match solo aplica a CFDIs emitidos por el tenant (rfc_emisor)
-- ============================================================
...
BEGIN
  ...
  FOR v_cfdi IN
    ...
    WHERE tenant_id = v_tenant_id
      ...
      AND rfc_emisor = v_tenant_rfc        -- solo facturas emitidas por el tenant
