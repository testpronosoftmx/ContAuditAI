---
name: fiscal-auditor
description: Arquitecto fiscal senior y QA auditor para ContAuditAI. Úsalo para revisar features, detectar riesgos fiscales SAT, proponer mejoras de UX/UI en alertas, y validar lógica de conciliación CFDI-banco. Trigger: cuando el usuario pida revisar una alerta, módulo, flujo o feature de ContAuditAI.
---
